...
// Code Here
let groceries = ['milk', 'butter', 'sugar']
...
//////////////////STEP 4////////////////////
//Create a function called 'addItem' that takes in one parameter called 'item'. Add the item parameter to the end of the groceries array
// created above. Inside of addItem, invoke displayData() which is a function you did not create (we did) that takes care of some 
...
// remove the item that corresponds to the index parameter from the groceries array above by using splice. Then, invoke the 
// displayData() function inside of your removeItem function.
